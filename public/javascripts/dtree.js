...
function dTree(objName) {
	...
	this.icon = {
		root		 : '/public/images/admin/role/base.gif',
		folder		 : '/public/images/admin/role/folder.gif',
		folderOpen	 : '/public/images/admin/role/folderopen.gif',
		node		 : '/public/images/admin/role/page.gif',
		empty		 : '/public/images/admin/role/empty.gif',
		line		 : '/public/images/admin/role/line.gif',
		join		 : '/public/images/admin/role/join.gif',
		joinBottom	 : '/public/images/admin/role/joinbottom.gif',
		plus		 : '/public/images/admin/role/plus.gif',
		plusBottom	 : '/public/images/admin/role/plusbottom.gif',
		minus		 : '/public/images/admin/role/minus.gif',
		minusBottom	 : '/public/images/admin/role/minusbottom.gif',
		nlPlus		 : '/public/images/admin/role/nolines_plus.gif',
		nlMinus		 : '/public/images/admin/role/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
